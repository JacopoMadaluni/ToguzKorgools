...
public class PlayerTest {
    ...
    public void testMoveWithTuzes(){
        ...
        assertEquals(10, player.getHole(6).getKorgools());
        assertEquals(10, player.getHole(7).getKorgools());
        assertEquals(10, player.getHole(8).getKorgools());
